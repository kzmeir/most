   ...
   ========================================================= */
{
  ...
  s.addNotes(
    ...
    "Если спросят про устойчивость этого уровня — отвечать структурой объекта, а не спором о процентах: " +
    "от суточной загрузки зависит лишь 27 % полезной площади, остальное это аренда бизнес-центра " +
    "и событийная сдача конференц-блока.\n" +
