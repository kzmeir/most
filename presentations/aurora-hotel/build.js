   ...
   ========================================================= */
{
  ...
  s.addText(
    [
      { text: "400 – 450", options: { fontFace: F, fontSize: 26, bold: true, color: ORANGE } },
  ...
  body(s, CX, 5.92, CW, 0.9,
    "Расчёт от 12 693,32 м² чистой площади номеров при среднем номере 28–32 м². " +
  ...
  pageNo(s);
  s.addNotes(
    "ВАЖНО: 400–450 номеров — оценка бюро, а не утверждённая цифра. Так и формулировать.\n" +
    "База: 12 693,32 м² чистой площади номеров ÷ 28–32 м² на номер = 397–453.\n" +
   ...
   ========================================================= */
{
  ...
  const fw = 4.0;
  figure(s, CX, 1.15, fw - 0.3, "400 – 450", "", "Номеров 4 звезды к фонду Алматы (оценка)", { size: 24, lh: 0.5 });
  figure(s, CX + fw, 1.15, fw - 0.3, "240 – 315", "", "Постоянных рабочих мест в гостинице (оценка)", { size: 24, lh: 0.5 });
  ...
  pageNo(s);
  s.addNotes(
    "ВНИМАНИЕ: 240–315 рабочих мест — расчёт от отраслевого ориентира 0,6–0,7 сотрудника на номер " +
    "для гостиниц 4 звезды, применённого к оценке 400–450 номеров. Это оценка, не факт.\n" +
