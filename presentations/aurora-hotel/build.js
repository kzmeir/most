...
function fitImage(slide, img, bx, by, bw, bh) {
  ...
  const w = iw * k, h = ih * k;
  slide.addImage({ path: img, x: bx + (bw - w) / 2, y: by + (bh - h) / 2, w, h });
}
   ...
   ========================================================= */
{
  ...
  fitImage(s, A("situation_new.jpg"), 0.55, 1.05, 7.4, 5.55);
   ...
   ========================================================= */
{
  ...
  fitImage(s, A("genplan_new.jpg"), 0.55, 1.2, 6.62, 5.7);
