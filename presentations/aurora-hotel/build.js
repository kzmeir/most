   ...
   ========================================================= */
{
  ...
  pageNo(s);
  s.addNotes(
    "Цифры идут сразу после зонирования: схема называет функции, таблица их считает. Дальше только картинки.\n" +
