   ...
   ========================================================= */
{
  ...
  s.addNotes(
    ...
    "Дека построена так: сначала образ и весь визуальный ряд, объяснения после. Если во время показа кадров " +
    "спросят «а где это» — ответить одной фразой устно (свободный участок 1,4 га на Бухтарминской, " +
    "деловое окружение) и не перескакивать на слайд 17, он и так впереди."
  );
}
   ...
   ========================================================= */
{
  ...
  pageNo(s);
  s.addNotes(
    "Первый содержательный слайд: дека открывается образом, а не анализом. Задаёт тон всему показу.\n" +
   ...
   ========================================================= */
{
  ...
  pageNo(s);
  s.addNotes(
    "Здесь начинается объяснительная часть: до этого показывали объект, дальше отвечаем где, как село и сколько.\n" +
   ...
   ========================================================= */
{
  ...
  fitImage(s, A("aerial.jpg"), 0.55, 1.02, 6.95, 5.95);
  ...
  pageNo(s);
  s.addNotes(
    "Посадка показана объёмом, а не чертежом: два корпуса, кольцевой проезд, стоянки по периметру, " +
    "рядовая посадка деревьев. Так читается за пять секунд, чертёж этого не даёт.\n" +
