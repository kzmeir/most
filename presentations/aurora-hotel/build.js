   ...
   ========================================================= */
{
  ...
  figure(s, CX + 3 * gw, 1.32, gw - 0.3, "69,5", "%", "Загрузка 2024 года при среднем за девять лет 54 %", { size: 29, lh: 0.7 });
  ...
  dashes(s, x2, 3.95, colW, 2.9, [
    "Признаков системного перегрева нет: 2022–2024 годы дали устойчивое восстановление и рост загрузки до 65–70 %.",
    "Рост спроса 5–7 % в год. Ввод номерного фонда 4–5 звёзд в 2026–2028 годах рынок поглотит, но конкурентное давление вырастет, а загрузка временно снизится.",
    "Рекомендован поэтапный ввод с фазой стабилизации 3–5 лет между объектами.",
  ], { size: 11 });

  caption(s, CX, 6.78, 12.23, "Источники: Cushman & Wakefield Kazakhstan, анализ рынка гостиничной недвижимости Алматы, 2025; открытые данные операторов.");
  ...
  s.addNotes(
    ...
    "Загрузка 69,5 % в 2024 — исторический пик, среднее за девять лет 54 %. На этом и строится осторожность: " +
    "заходить в рынок на пике полным объёмом рискованно.\n" +
