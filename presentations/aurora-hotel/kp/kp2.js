...
const NET = 29385241.38, VAT = 4701638.62, GROSS = 34086880.00;
const money = (n) => {
...
const doc = new Document({
  ...
  sections: [{
    ...
    children: [
      ...
      gap(140),
      p(t("Стоимость работ с НДС за 1 м\u00b2 полезной площади: " +
        RATE_TOTAL.toLocaleString("ru-RU").replace(/\u00a0/g, " ") + " тенге.",
        { size: 18, color: INK })),
