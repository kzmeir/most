...
const SUM_F = 5207798, SUM_C = 10415596, SUM_E = 36454586, SUM_T = 52077980;
const NET = 44894810.34, VAT = 7183169.66;
  ...
  sections: [{
    ...
    children: [
      ...
      table([3000, W - 3000], [
        ...
        ["Стадия", "Форэскиз (выполнен), концепция и эскизный проект"],
      ...
      table([W - 3200, 3200], [
        ...
        ["Подземный этаж 4 941,11 м² с понижающим коэффициентом 0,7", "3 458,78 м²", false],
        ["Расчётная площадь для определения стоимости", "26 038,99 м²", true],
      ...
      gap(140),
      p(t("Стоимость указана с учётом НДС, расчёт от площади 26 038,99 м². В том числе: сумма без НДС — " +
        money(NET) + ", НДС 16 % — " + money(VAT) + ".", { size: 17, color: GREY, italics: true })),

      /* 3 */
      h2("3. Состав работ"),
      p([t("Стадия 1. Форэскиз", { bold: true, color: INK, size: 21 }),
         t("   — выполнено", { bold: true, color: ORANGE, size: 17 })], { after: 120 }),
      ...
      table([W - 3200, 3200], [
        ["Стадия 1. Форэскиз", "выполнено"],
        ["Стадия 2. Концепция", "1 месяц"],
        ["Стадия 3. Эскизный проект", "2 месяца"],
        ["Всего по оставшимся стадиям", "3 месяца"],
      ].map(([k, v], i, a) => new TableRow({
        children: [
      ...
      /* 5 */
      h2("5. Порядок оплаты"),
      li("Стадия 1 (выполнена): 100 % при подписании договора"),
