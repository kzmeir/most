...
/* ---------- значения ---------- */
const AREA = 27521.32;
const RATE_TOTAL = 2000, RATE_C = 600, RATE_E = 1400;
const SUM_C = 16512792, SUM_E = 38529848, SUM_T = 55042640;
...
const doc = new Document({
  ...
  sections: [{
    ...
    children: [
      ...
      p(t("на разработку концепции и эскизного проекта гостиничного комплекса", { size: 21, color: TXT }), { after: 320 }),
      ...
      table([3000, W - 3000], [
        ...
        ["Стадия", "Концепция и эскизный проект"],
      ...
      table([W - 3200, 3200], [
        ...
        ["Подземный этаж — паркинг (расчётно, по пятну застройки)", "4 941,11 м²", false],
        ["Расчётная площадь объекта", "27 521,32 м²", true],
      ...
      table([W - 4400, 1400, 1500, 1500], [
        ...
        ...[
          ["Стадия 1. Концепция", "30 %", RATE_C, SUM_C, false],
          ["Стадия 2. Эскизный проект", "70 %", RATE_E, SUM_E, false],
      ...
      gap(140),
      p(t("Стоимость указана без учёта НДС. Расчёт от площади 27 521,32 м².", { size: 17, color: GREY, italics: true })),

      /* 3 */
      h2("3. Состав работ"),
      p(t("Стадия 1. Концепция", { bold: true, color: INK, size: 21 }), { after: 120 }),
      ...
      li("Технико-экономические показатели, коэффициенты застройки и использования территории"),
      li("Архитектурное решение фасадов, ведомость отделочных материалов"),
      li("Визуализации — 6 ракурсов (экстерьер и интерьеры общественных зон)"),
      li("Комплект презентационных материалов для градостроительного совета"),
      gap(180),
      p(t("Стадия 2. Эскизный проект", { bold: true, color: INK, size: 21 }), { after: 120 }),
      li("Планировочные решения этажей, типы номеров, итоговая ёмкость номерного фонда"),
      ...
      li("Фасады и характерные разрезы"),
      ...
      table([W - 3200, 3200], [
        ["Стадия 1. Концепция", "3 недели"],
        ["Стадия 2. Эскизный проект", "4 недели"],
        ["Всего", "7 недель"],
      ].map(([k, v], i, a) => new TableRow({
        children: [
      ...
      /* 7 */
      h2("7. Условия"),
      li("В стоимость каждой стадии включены два круга корректировок по замечаниям заказчика. Последующие корректировки, а также изменение ранее согласованных решений оплачиваются отдельно по ставке ______ ₸ за час"),
