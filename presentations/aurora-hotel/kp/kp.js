...
const SUM_F = 5504264, SUM_C = 11008528, SUM_E = 38529848, SUM_T = 55042640;
const NET = 49145214.29, VAT = 5897425.71;
...
const doc = new Document({
  ...
  sections: [{
    ...
    children: [
      ...
      gap(140),
      p(t("Стоимость указана с учётом НДС, расчёт от площади 27 521,32 м². В том числе: сумма без НДС — " +
        money(NET) + ", НДС 12 % — " + money(VAT) + ".", { size: 17, color: GREY, italics: true })),
      ...
      li("Варианты посадки и объёмно-пространственного решения"),
      li("Предварительные технико-экономические показатели"),
      li("Выбор направления для дальнейшей проработки"),
      gap(180),
